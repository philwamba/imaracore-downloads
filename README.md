...
**[Download imaracore-v0.2.0-build.2.apk](https://github.com/philwamba/imaracore-downloads/releases/download/v0.2.0-build.2/imaracore-v0.2.0-build.2.apk)**
...
Releases are tagged `vMAJOR.MINOR.PATCH-build.NUMBER` (for example, `v0.2.0-build.2`)
and every APK carries its version in its file name (for example, `imaracore-v0.2.0-build.2.apk`).
