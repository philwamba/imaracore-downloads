...
**Current version: 0.5.1 (build 8)**

**[Download imaracore-v0.5.1-build.8.apk](https://github.com/philwamba/imaracore-downloads/releases/download/v0.5.1-build.8/imaracore-v0.5.1-build.8.apk)**
...
Releases are tagged `vMAJOR.MINOR.PATCH-build.NUMBER` (for example, `v0.5.1-build.8`)
and every APK carries its version in its file name (for example, `imaracore-v0.5.1-build.8.apk`).
